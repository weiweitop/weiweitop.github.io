...
[Jekyll Table of Contents](#jekyll-table-of-contents) + [Scrollspy](#bootstrap-scrollspy)：由于Scrollspy需要指定`<a>`的class，提交了一个{% include outerlink.html name="Pull Request" link="https://github.com/ghiculescu/jekyll-table-of-contents/pull/29" %}到Jekyll Table of Contents来支持这个配置。
