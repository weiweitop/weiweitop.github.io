...
我的就是韩版，包装盒、说明书和机器铭牌上面是韩语，但系统菜单是英语，版本显示的是`4.1U`，是当初电玩店改的区。

系统菜单4.2真是***罄竹难书***：

1. 它把boot2升级到boot2v4，但升级程序本身的问题造成升级过程中容易变砖，也就是说正常升级都要变砖，不管有没有软改:sob:
1. 就算成功升级了boot2v4，如果降级系统菜单或降级IOS也会变砖。当然，降级的方式已经过时了。
1. 它让改区韩版变砖，这就是著名的`Error: 003, Unauthorized device Detected`
