...
就算HBC是个APP（//TODO wad --> app?），通过系统漏洞来运行它，但不要忘了，Bannerbomb和Letterbomb也是破解的系统菜单，其他的漏洞也需要从系统菜单的Disc Channel进入游戏。
...
- cIOS236（基于IOS36），安装器是IOS236_Installer_v6，把任天堂修复的Bug又恢复回来，这就是著名的FakeSign Bug (Trucha bug，Signing bug，Strncmp bug) //TODO 用来干什么的
