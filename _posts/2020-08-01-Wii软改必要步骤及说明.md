...
- cIOS236（基于IOS36），安装器是IOS236_Installer_v6，把任天堂修复的Bug又恢复回来，这就是著名的FakeSign Bug (Trucha bug，Signing bug，Strncmp bug) 。老版本的Installer直接安装在了slot36，新版本的才分开安装到了slot236。
...
- Hermes的cIOS202、cIOS222、cIOS223、cIOS224，分别基于哪个IOS要看安装器的版本。大概是IOS37、IOS38、IOS57和IOS60这几个。
